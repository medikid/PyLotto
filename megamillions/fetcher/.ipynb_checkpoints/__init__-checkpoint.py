...
class Fetcher():
    ...
    def fetch_results(self, StartID=1468, StartDate='2020-07-10'):
        str_url = "https://www.lotteryusa.com/mega-millions/year"
        start_id = StartID
        res = list();
        ...
        for tr in  doc.findAll("tr",{"class":"c-game-table__item"}):
            ...
            try:
                ...
                lis_mega = tr.find("span",{"class":"c-result__ball c-result__ball--yellow"});
                num=[]
                for li in lis:
