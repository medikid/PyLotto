...
from powerball.models import iresult, ipick
from nbconvert.exporters.base import export
from powerball.models.iresult import iResult
...
class Fetcher():
    ...
    def fetch_results(self, StartID=654, StartDate='2020-07-10'):
        str_url = "https://www.lotteryusa.com/powerball/year"
        start_id = StartID
        res = list();
        ...
        for tr in  doc.findAll("tr",{"class":"c-game-table__item"}):
            ...
            try:
                ...
                lis_mega = tr.find("span",{"class":"c-result__ball c-result__ball--red"});
                num=[]
                for li in lis:
