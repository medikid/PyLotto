...
class Fetcher():
    ...
    def fetch_results(self):
        evening_url_str="https://www.lotteryusa.com/california/fantasy-5/year";
        evening_draw_time= "18:30"
        
        res_ev = self.fetch(evening_url_str, evening_draw_time);
        res_ev_df = pd.DataFrame(res_ev, columns=['draw_dttm','r1','r2','r3','r4','r5'])
    ...
    def fetch(self, url, draw_time):
        ...
        for tr in  doc.findAll("tr",{"class":"c-game-table__item"}):
            try:
                ...
                res.append([draw_dttm, num[0],num[1],num[2],num[3],num[4]])
            except:
                pass;
