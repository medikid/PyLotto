...
from keno.strategies.ai.pytorch.v_2_00.keno_dataset import KenoDataset
...
keno = KenoDataset('train_1.npz', 'train')
...
for i in range(keno.__len__()):
    ...
    #criterion = BCELoss(); loss = criterion(model.forward(x), y)
...
#    loss = nn.MSELoss()
    ...
    print(i,ids, "loss :" , loss , " %");
print("Training Complete")
    
torch.save(model.state_dict(), 'TrainedModel_v_3_00.pt')
